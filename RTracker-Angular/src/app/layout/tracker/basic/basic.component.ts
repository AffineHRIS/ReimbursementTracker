...
export class BasicComponent implements OnInit {
    ...
    statusFind(value):void {
        ...
        else if(value == "Hold" || value == "Submitted") {
            this.whenAccept = false;
            this.whenHold = true;
            this.whenPaid = true;
        }
    ...
    searchValue(value: any): void {
        ...
        showClaim(claimId) : void {
            ...
            this.reimbService.getClaim(claimId.Claim_Id).then(claimvalues => {
                this.OrigReimbDetails = Object.assign({}, claimvalues[0]);
                this.ReimbursementDetails = Object.assign({}, claimvalues[0]);

                // console.log( Object.is(this.OrigReimbDetails, this.ReimbursementDetails) );
                ...
                else if(this.ReimbursementDetails.Status == "Hold" || this.ReimbursementDetails.Status == "Submitted") {
                    this.whenAccept = false;
                    this.whenHold = true;
                    this.whenPaid = true;
                }
        ...
        save(model : any) {
            ...
            if (this.form.valid) {
                var modelData = Object.assign({}, model);
                if ( this.OrigReimbDetails.Status ) {
                    modelData['Old_Status'] = this.OrigReimbDetails.Status;
                }
